...
NAN_SETTER(Layer::set_prop)
{
    ...
    else if (a == "minimum_scale_denominator")
    {
        ...
        l->layer_->set_minimum_scale_denominator(value->NumberValue(Nan::GetCurrentContext()).ToChecked());
    }
    else if (a == "maximum_scale_denominator")
    {
        if (!value->IsNumber()) {
        ...
        l->layer_->set_maximum_scale_denominator(value->NumberValue(Nan::GetCurrentContext()).ToChecked());
    }
    else if (a == "queryable")
    {
        if (!value->IsBoolean()) {
